...
<%--    </header>--%>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1><small></small></h1>
            <ol class="breadcrumb">
                <li><i class="fa fa-dashboard">&nbsp;<a href="../page/product-list.jsp">返回商品列表</a></i></li>
        ...
        <section class="content container-fluid">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" id="fm-add" role="form" action="../action/ProductAddServlet" method="post"
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2021 <a href="http://www.XXX.cn"></a>.</strong> All rights reserved.
    </footer>
