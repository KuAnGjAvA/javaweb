...
<%--<%-====================== fsdfsdfdsfsdf图片========================================================================&ndash;%&gt;--%>
<%--              <img src="../img/setting.png" class="user-image" alt="User Image">--%>
<%--              <!-- hidden-xs hides the username on small devices so only the image appears. -->--%>
<%--              <span class="hidden-xs"><%=((User)session.getAttribute("user")).getUname() %></span>--%>
<%--            </a>--%>
...
<%--                <div class="pull-left">--%>
<%--                  <a href="../action/PasswordChangeServlet" class="btn btn-default btn-flat">修改密码11</a>--%>
<%--                </div>--%>
    ...
    <section class="content container-fluid">
      <div class="my_content">
        ...
        <div class="box box-primary">
          ...
          <form class="form-horizontal" method="post" action="../action/PasswordChangeServlet">
            <input type="hidden" name="user.uname" id="cpassword" value="<%=((User)session.getAttribute("user")).getUname() %>" >
            <div class="box-body">
