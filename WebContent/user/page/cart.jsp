...
<c:forEach var="item" items="${requestScope.cart }">
                <div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="${item.cartItem.rid }">
                            <img src="../img/goods/${item.book.isbn }/detail1.jpg" class="lf"/>
                            <input type="hidden" name="" value="">
                        <span class="des lf">
                         ${item.book.title }
                              <input type="hidden" name="" value="">
                        </span>
                            <p class="col lf"><span>作者：</span><span class="color_des">${item.book.author } <input type="hidden" name="" value=""></span></p>
                        </div>
                    </div>
                    <div class="pices">
                        <p class="pices_des"></p>
                        <p class="pices_information"><b>￥</b><span>${item.book.price }<input type="hidden" name="" value=""></span></p>
                    </div>
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${item.cartItem.count }" ><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${item.book.price }</span>
                    </div>
                    <div class="del">
