...
<!--订单确认-->
<form action="../page/pay-success.jsp" method="post" id="pay_form">
    <input type="hidden" name="payment" value="${requestScope.payment }"/>
    <input type="hidden" name="orderId" value="${requestScope.orderId }"/>
    <div id="container" class="clearfix" >
        <!-- 支付订单信息-->
        <div class="pay_info">
            <b>支付金额：<i>${requestScope.payment }元</i></b>
            <span>支付订单：${requestScope.orderId } 收款方：嘉应学院商城</span>
        </div>
        <!--支付方式-->
        <div id="pay_type">
            <!-- 支付方式头-->
        ...
        <span class="pay_leftTime">
            ...
            <span  class="okPay" onclick="payment()">确认支付</span>
