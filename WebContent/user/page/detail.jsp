...
<!--细节导航-->
<div id="nav_detail">
    <h5>${requestScope.bookVo.book.title }></h5>
</div>
<!--产品预览-->
<div id="shop_detail">
    <!-- 左侧-->
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" src="../img/goods/${requestScope.bookVo.book.isbn }/detail1big.jpg"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
                <li class="i1"><img src="../img/goods/${requestScope.bookVo.book.isbn }/detail1.jpg" /></li>
                <li class="i1"><img src="../img/goods/${requestScope.bookVo.book.isbn }/detail2.jpg" onerror="this.style.display='none'" /></li>
                <li class="i1"><img src="../img/goods/${requestScope.bookVo.book.isbn }/detail3.jpg" onerror="this.style.display='none'" /></li>
                <li class="i1"><img src="../img/goods/${requestScope.bookVo.book.isbn }/detail4.jpg" onerror="this.style.display='none'" /></li>
                <li class="li"><img src="../img/goods/${requestScope.bookVo.book.isbn }/detail5.jpg" onerror="this.style.display='none'" /></li>
            </ul>
        </div>
    </div>
    <!-- 右侧-->
    <div class="right_detail lf">
        <!-- 图书名称-->
        <h1>${requestScope.bookVo.book.title }</h1>
        <!-- 图书作者 -->
        <h3>${requestScope.bookVo.book.author }</h3>
        <!-- 价格部分-->
        <div class="price">
            <div id="pro_price"><b>价格：</b><span>￥${requestScope.bookVo.book.price }</span></div>
            <div class="promise">
                <b>服务承诺：</b>
                <span>*退货补运费</span>
                <span>*30天无忧退货</span>
        ...
        <p class="style" id="choose_color">
            <s class="color">出版社：</s>
            <span>${requestScope.bookVo.book.press }</span>
        </p>
        <!-- 出版日期 -->
        <p>
            <s>出版日期：</s>
            <span>${requestScope.bookVo.book.published }</span>
        </p>
        <!-- 未选择规格，颜色时状态-->
        ...
        <div class="shops">
            ...
            <a href="#" class="collection lf" id="collect"><span>收藏</span></a><b><img src='../img/product_detail/product_detail_img6${empty requestScope.bookVo.rid?"":"2" }.png' alt=""/></b>
        </div>
    </div>
</div>
<!--为你推荐-->
            ...
            <div id="demo1" style="float:left"><!-- 第一个宽度显示 -->
                 <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="../action/DetailServlet?isbn=9787302435167"><img src="../img/recommend/recommend_img1.jpg" border="0"></a>
                    </div>
                    <p>大数据架构师指南</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="../action/DetailServlet?isbn=9787115335500"><img src="../img/recommend/recommend_img2.jpg" border="0"></a>
                    </div>
                    <p>深入浅出Node.js</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="../action/DetailServlet?isbn=9787111213826"><img src="../img/recommend/recommend_img3.jpg" border="0"></a>
                    </div>
                    <p>Java编程思想</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="../action/DetailServlet?isbn=9787111545682"><img src="../img/recommend/recommend_img4.jpg" border="0"></a>
                    </div>
                    <p>Linux运维最佳实践</p>
                </div>
                <!--</div>-->
    ...
    <div class="left lf">
        <div class="all">
            ...
            <div id="parm">
                ...
                <ul>
                    <li><a href="#">图书编号：${requestScope.bookVo.book.isbn }</a></li>
                    <li>
                    	<a href="#">图书名称：



					            	${requestScope.bookVo.book.title }
                    ...
                    <li>
                    	<a href="#">作者：
					            	...
					            	${requestScope.bookVo.book.author }



		            	</a>
		            </li>
                    <li><a href="#">价格：￥{requestScope.bookVo.book.price }</a></li>
                    <li><a href="#">出版社：${requestScope.bookVo.book.press }</a></li>
                    <li><a href="#">版次：${requestScope.bookVo.book.edition }</a></li>
                    <li><a href="#">出版日期：${requestScope.bookVo.book.published }</a></li>
                    <li><a href="#">页数：${requestScope.bookVo.book.pages }</a></li>
                    <li>
                    	<a href="#">字数：
${requestScope.bookVo.book.words }
                    	</a>
                    </li>
                    <li><a href="#">包装：${requestScope.bookVo.book.packaging }</a></li>
                    <li><a href="#">开本：${requestScope.bookVo.book.format }</a></li>
                    <li><a href="#">用纸：${requestScope.bookVo.book.form }</a></li>
                </ul>
            </div>
            <div id="product_introduction">
                ...
                <img src="../img/goods/${requestScope.bookVo.book.isbn }/intro.jpg" alt=""/>
            </div>
            <div id="sale_protection">
                ...
                <div class="sale_content">
                    ...
                    <p class="content">
                        嘉应学院学子商城向您保证所售商品均为正品行货，嘉应学院自营商品开具机打发票或电子发票。
                    </p>
                    ...
                    <p class="content">
                        凭质保证书及嘉应学院商城发票，可享受全国联保服务，与您亲临商场选购的商品享受相同的质量保证。嘉应学院商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！
...
<script>
    $(function () {
        ...
        $("#collect").click(function (){
           	...
           	$.ajax({
                type: "post",
                url: '../action/${empty requestScope.bookVo.rid?"CollectServlet":"CancelCollectServlet" }',
                data: "userId=${sessionScope.user.phone }&product=${requestScope.bookVo.book.isbn }",//params,
                success: function (data) {
                    if (data == 'yes') {
                    	alert("操作完成！");
                    	window.location.href = "../action/DetailServlet?isbn=${requestScope.bookVo.book.isbn }";
                    } else {
                        alert("操作失败！");
                    }
                },
        ...
        $("#buy_now").click(function (e) {
            var num = $("#buy-num").val();
            // 后台需要的参数
            var url = "../action/BuyNowServlet?product=${requestScope.bookVo.book.isbn }&count="+num;
...
<script>
    ...
    $("#add_cart").click(function (e) {
        ...
        var params = {
        	count: buyAccount,
        	product: ${requestScope.bookVo.book.isbn }
        };
        $.ajax({
            type: "post",
            url: "../action/AddToCartServlet",
            data: params,
            success: function (data) {
                if (data == 'yes') {
                    alert("添加购物车成功！");
