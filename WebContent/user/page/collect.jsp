    ...
    <form  name="" action="" method="post" >
        <section id="section" >
            ...
            <div id="box" >
		        ...
		        <div id="content_box" >
		        <c:forEach var="book" items="${requestScope.collects }" varStatus="sta" >
                    <div class="lf" id="d${sta.count }">
                        <div class="img">
                            <a href="../servlet/detail?isbn=${book.isbn }">
                              <img src="../img/goods/${book.isbn }/collect.jpg" alt=""/>
                            </a>
                        </div>
                        <div class="describe">
                            <p>${book.title }</p>
                            <span class="price"><b>￥</b><span class="priceContent">${book.price }</span></span>
                            <span class="addCart"><a href="../servlet/detail?isbn=${book.isbn }">查看</a></span>
