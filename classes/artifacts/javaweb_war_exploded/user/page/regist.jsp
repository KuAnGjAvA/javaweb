...
<div class="parent">
  <div class="container">
    <div class="panel rt">
      <form id="fm-register" method="post" action="../action/RegistServlet">
        <div class="txt">
          <p id="newuser">新用户注册
            <span>
              <a href="../page/login.jsp" id="dlogin">直接登录</a>
            </span>
          </p>
        </div>
