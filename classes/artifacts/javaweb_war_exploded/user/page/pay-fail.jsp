...
<%--    <div class="rt">--%>
<%--        <ul class="lf">--%>
<%--            <li><a href="index.html" >首页sdf</a><b>|</b></li>--%>
<%--            <li><a href="collect.html" >收藏fsdf</a><b>|</b></li>--%>
<%--            <li><a href="order.html" >订单fsdf</a><b>|</b></li>--%>
<%--            <li><a href="cart.html" >购物车sf</a><b>|</b></li>--%>
<%--            <li><a href="../page/password-change.jsp">设置df</a><b>|</b></li>--%>
...
<div id="container">
    ...
    <div class="rightsidebar_box rt" >
        <div class="pay_result">
            ...
            <br/>
            嘉应学院学子商城不会以系统异常、订单升级为由，要求你点击任何链接进行退款操作！
        </div>
