...
<script>
 $(function () {
   $('#my_order').DataTable({
     ...
     'processing': true,
     'serverSide': true,
     'ajax': '../action/ProductListServlet',
     'columns': [
    	    { 'data': 'isbn' },
    	    { 'data': 'title' },
    	    ...
    	    { 'data': null , 'render': function (data, type, row, meta) { 
    	    		return '<a href="../action/ProductDetailServlet?isbn='+row.isbn+'">查看</a>丨<a href="../action/ProductEditServlet?isbn='+row.isbn+'">编辑</a>丨<a onclick="deleteProduct(event)" href="../action/ProductDeleteServlet?isbn='+row.isbn+'">删除</a>';
	    		}
    	    }
    	  ],
